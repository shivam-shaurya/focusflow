...
export const NAV: NavEntry[] = [
  { id: 'today', label: 'Today', icon: LayoutGrid, hint: 'One day at a time', keywords: 'home dashboard now tasks goals' },
  { id: 'planner', label: 'Planner', icon: CalendarDays, hint: 'The week ahead', keywords: 'week schedule plan upcoming' },
  ...
  { id: 'newme', label: 'New Me', icon: Flame, hint: 'Read every day', keywords: 'identity habits rules manifesto' },
